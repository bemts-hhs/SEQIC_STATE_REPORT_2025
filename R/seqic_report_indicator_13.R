...
### SEQIC Indicator Calculations 2025 - Indicator 13 Data Validity
...
# Regions
seqic_indicator_13_regions <- trauma_2020_2024 |>
...
# Level
seqic_indicator_13_level <- trauma_2020_2024 |>
  traumar::seqic_indicator_13(
    level = Level,
    unique_incident_id = Unique_Incident_ID,
    validity_score = Validity_Score,
...
# Agency-specific
seqic_indicator_13_results <- trauma_2020_2024 |>
  traumar::seqic_indicator_13(
    level = Level,
    unique_incident_id = Unique_Incident_ID,
    validity_score = Validity_Score,
  ...
  join_comparison_data(
    data_level = seqic_indicator_13_level,
    data_region = seqic_indicator_13_regions
  )
...
# state level
seqic_indicator_13_results_state <- trauma_2020_2024 |>
  traumar::seqic_indicator_13(
    level = Level,
    unique_incident_id = Unique_Incident_ID,
    validity_score = Validity_Score,
...
seqic_indicator_13_results_state_age <- trauma_2020_2024 |>
  traumar::seqic_indicator_13(
    level = Level,
    unique_incident_id = Unique_Incident_ID,
    validity_score = Validity_Score,
...
# service areas
seqic_indicator_13_results_service_areas <- trauma_2020_2024 |>
  traumar::seqic_indicator_13(
    level = Level,
    unique_incident_id = Unique_Incident_ID,
    validity_score = Validity_Score,
...
seqic_indicator_13_results_verification <- trauma_2020_2024 |>
  traumar::seqic_indicator_13(
    level = Level,
    unique_incident_id = Unique_Incident_ID,
    validity_score = Validity_Score,
...
export_seqic_data(
  ...
  seqic_results = seqic_indicator_13_results,
  indicator = "indicator_13"
)

# state level reporting
export_state_data(
  x = seqic_indicator_13_results_state,
  subfolder = "13"
)

# state level by age reporting
export_state_data(
  x = seqic_indicator_13_results_state_age,
  subfolder = "13"
)

# service area level reporting
export_state_data(
  x = seqic_indicator_13_results_service_areas,
  subfolder = "13"
)

# verification level reporting
export_state_data(
  x = seqic_indicator_13_results_verification,
  subfolder = "13"
)
