...
# state level
seqic_indicator_4_results_state <- trauma_2020_2024 |>
  traumar::seqic_indicator_4(
    level = Level,
    ed_disposition = ED_Acute_Care_Disposition,
    ed_LOS = Length_of_Stay,
...
seqic_indicator_4_results_state_age <- trauma_2020_2024 |>
  traumar::seqic_indicator_4(
    level = Level,
    ed_disposition = ED_Acute_Care_Disposition,
    ed_LOS = Length_of_Stay,
...
# service areas
seqic_indicator_4_results_service_areas <- trauma_2020_2024 |>
  traumar::seqic_indicator_4(
    level = Level,
    ed_disposition = ED_Acute_Care_Disposition,
    ed_LOS = Length_of_Stay,
...
export_state_data(
  x = seqic_indicator_4_results_state_age,
  subfolder = "4"
)

# service area level reporting
export_state_data(
  x = seqic_indicator_4_results_service_areas,
  subfolder = "4"
)
